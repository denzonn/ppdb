<div class="flex flex-col h-full justify-between text-gray-600">
    <ul class="flex flex-col gap-4 menu text-base">
        ...
        <a href="/admin/information"
            ...
            <div class="flex flex-row gap-2 items-center"><i class="fa-solid fa-circle-info"></i>Informasi Pendaftaran</div>
        </a>
        <a href="/admin/student-register"
            ...
            <div class="flex flex-row gap-2 items-center"><i class="fa-solid fa-user-plus text-sm"></i> Peserta Pendaftaran</div>
        </a>
    </ul>
    <div>
        <ul>
